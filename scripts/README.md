...
- `batch_ingest_folder.py` — Batch-ingests a folder of evidence files by calling the API. Example: `python scripts/batch_ingest_folder.py --case-id BCSC_138865 --folder ~/Mitchopolis/parenting_evidence/inbox --file "OFW_Messages_Report_2026-01-26_07-24-21 (1).pdf"`.
